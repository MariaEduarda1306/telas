...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (faseSelect && faseWrapper) {
        ...
        options.forEach(option => {
            option.addEventListener('click', () => {
                ...
                // Atualiza o select escondido e dispara o filtro
    ...
    function renderStudentsTable() {
        ...
        const faseFilter = document.getElementById('filtro-fase').value; // Pega do select escondido
        ...
        const filteredStudents = allStudentsData.filter(aluno => {
            ...
            return matchNome && matchMatricula && matchCurso && matchFase;
        });
    ...
    if (clearFiltersBtn) {
        clearFiltersBtn.addEventListener('click', (e) => {
            ...
            // Reseta o Select Escondido e o Visual Customizado
