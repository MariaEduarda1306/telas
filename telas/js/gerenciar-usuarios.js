document.addEventListener('DOMContentLoaded', () => {
    ...
    // NOVOS SELETORES (assumindo que o HTML foi atualizado)
    ...
    document.getElementById('add-user-btn').addEventListener('click', () => {
        ...
        // ATUALIZADO: Mostra campo de nascimento, esconde senha
    ...
    function openEditModal(user) {
        ...
        // ATUALIZADO: Esconde nascimento, mostra campo de nova senha
        if (nascimentoGroup && passwordGroup) {
            nascimentoGroup.classList.add('hidden');
            passwordGroup.classList.remove('hidden');
        }
        document.getElementById('data_nascimento').required = false;
        document.getElementById('password').required = false; // Senha é opcional na edição
    ...
    userForm.addEventListener('submit', async (e) => {
        ...
        // ==================================================
        if (isEditing) {
            // Se está editando, envia 'password' se preenchido
            const password = document.getElementById('password').value;
            if (password && password.trim() !== '') {
                data.password = password;
            }
        } else {
            // Se está criando, envia 'data_nascimento'
            data.data_nascimento = document.getElementById('data_nascimento').value;
        }
        // ==================================================
